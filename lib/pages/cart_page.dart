...
import 'package:food_app/pages/payement_page.dart'; // Make sure this import matches your actual file name
                  ...
                  if (userCart.isEmpty) {
                    showDialog(
                      ...
                      builder: (context) => AlertDialog(
                        ...
                        content: const Text("You cannot proceed to checkout with an empty cart."),
                        actions: [
                          TextButton(
                            onPressed: () => Navigator.pop(context),
                            child: const Text('OK'),
